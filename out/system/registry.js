...
/* =========================================================
   Registry tree
   ========================================================= */
exports.BUILTIN_REGISTRY = ns("<root>", null, {
...
/* =========================================================
   Public helpers
   ========================================================= */
function resolveBuiltin(pathParts) {
    if (!pathParts.length)
        return exports.BUILTIN_REGISTRY;
    ...
    let node = exports.BUILTIN_REGISTRY;
...
function listChildren(pathParts) {
    const node = resolveBuiltin(pathParts);
    if (!node || node.kind !== "namespace")
        return [];
    return Object.values(node.children);
}
function isModuleEnabled(modCtx, moduleName) {
    if (modCtx.allInOneEnabled)
        return true;
...
/* =========================================================
   Builders
   ========================================================= */
function ns(name, module, children) {
    return { kind: "namespace", name, module, children };
}
function fn(name, module, meta) {
    return {
        kind: "function",
        name,
        module,
